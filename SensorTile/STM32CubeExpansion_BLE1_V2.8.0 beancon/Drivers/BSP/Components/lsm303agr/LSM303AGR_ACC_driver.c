...
/* Private functions ---------------------------------------------------------*/
static status_t LSM303AGR_ACC_ReadReg( void *handle, u8_t Reg, u8_t* Data );
static status_t LSM303AGR_ACC_WriteReg( void *handle, u8_t Reg, u8_t Data );
...
/*******************************************************************************
* Function Name		: LSM303AGR_ACC_MultiRead
* Description		: Generic Reading function. It must be fullfilled with either
*					: I2C or SPI reading functions					
* Input				: Register Address
* Output			: Data REad
* Return			: None
*******************************************************************************/
status_t LSM303AGR_ACC_MultiRead( void *handle, u8_t Reg, u8_t* Data, u16_t len ) 
{
  Reg |= 0x40;
...
/*******************************************************************************
* Function Name		: LSM303AGR_ACC_MultiWrite
* Description		: Generic Writing function. It must be fullfilled with either
*					: I2C or SPI writing function
* Input				: Register Address, Data to be written
* Output			: None
* Return			: None
*******************************************************************************/
status_t LSM303AGR_ACC_MultiWrite( void *handle, u8_t Reg, u8_t Data, u16_t len ) 
{
  Reg |= 0x40;
...
{
  return LSM303AGR_ACC_MultiRead(handle, LSM303AGR_ACC_OUT_X_L, buff, 6);
}
